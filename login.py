...
class Add_Guests_Page():
    ...
    Guests_name = (By.XPATH, '//*[@id="id_realname"]')  #嘉宾姓名
    commite_btn = (By.XPATH, '/html/body/div[1]/div[2]/form/div[7]/div/button')  # 提交
...
class LoginTestCase(unittest.TestCase):
    ...
    def test_login_case_01(self, username, password, status):
        ...
        if status == "0":
            ...
            Test_Add_Conference_Page(self.driver).commite_btn() #添加发布会 提交
            time.sleep(5)
            # suc=self.driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/form/div[6]/div/p')
            # print(suc.text)
            # self.assertEqual(suc.text,"添加发布会成功！")
            self.driver.back()
